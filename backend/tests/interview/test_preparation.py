    ...
    return _Client(
        {
            "resume_versions": [{
                ...
                "plain_text": "Python FastAPI React",
                "structured_content": {"sections": {"skills": "Python, FastAPI, React"}},
            }],
            "job_descriptions": [{
                "id": "job-description", "user_id": "candidate", "extraction_status": job_status,
                "role_title": "Backend Engineer",
                "raw_text": "Python FastAPI Docker SQL",
                "structured_content": {},
            }],
            "candidate_skills": [{"user_id": "candidate", "name": "Python", "normalized_name": "python"}],
            "candidate_projects": [{
                "user_id": "candidate", "title": "Career Copilot",
                "description": "A FastAPI project", "display_order": 0,
            }],
            "ats_analyses": [{
                "id": "analysis", "user_id": "candidate",
                "resume_version_id": "resume-version",
                "job_description_id": "job-description",
                "status": "completed", "overall_score": 72,
            }],
            "ats_evidence": [
                {
                    "analysis_id": "analysis", "user_id": "candidate",
